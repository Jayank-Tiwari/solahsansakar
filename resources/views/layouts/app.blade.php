...
<body class="font-sans antialiased bg-ss-cream text-ss-brown">
    ...
    <header class="bg-white/80 backdrop-blur-md shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="{{ route('home') }}" class="text-2xl font-serif text-ss-maroon font-bold tracking-wide">SolahSansakar</a>
            ...
            <div class="md:hidden flex items-center">
                <button id="mobile-menu-btn" class="text-ss-maroon focus:outline-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-1 text-sm">
                        ...
                        <li><a href="{{ route('packages.index') }}" class="hover:text-ss-saffron">Pooja Packages</a></li>
